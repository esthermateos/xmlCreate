...
public class DependenciesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DependenciesPackage.COMPONENT_SQL: {
				ComponentSQL componentSQL = (ComponentSQL)theEObject;
				T result = caseComponentSQL(componentSQL);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DependenciesPackage.LEVELS: {
				Levels levels = (Levels)theEObject;
				T result = caseLevels(levels);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DependenciesPackage.FTP: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Component SQL</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Component SQL</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComponentSQL(ComponentSQL object) {
		return null;
	}
